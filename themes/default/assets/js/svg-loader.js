const svgWrap = document.createElement('div'),
  ...
  <!-- SVG LOGO MyAds_Default_Theme -->
  <svg style="display: none;">
    <symbol id="svg-logo-MyAds_Default_Theme" viewBox="0 0 28 40" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG MEGAPHONE -->
  <svg style="display: none;">
    <symbol id="svg-megaphone" viewBox="0 0 20 20" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG DIRECTORY -->
  <svg style="display: none;">
    <symbol id="svg-directory" viewBox="0 0 20 20" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG ORDERS -->
  <svg style="display: none;">
    <symbol id="svg-orders" viewBox="0 0 20 20" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG NEWS -->
  <svg style="display: none;">
    <symbol id="svg-news" viewBox="0 0 20 20" preserveAspectRatio="xMinYMin meet">
