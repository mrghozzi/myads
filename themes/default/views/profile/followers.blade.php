...
@section('content')
<!-- Reusing Profile Header from show.blade.php logic or including it -->
<!-- For simplicity, duplicating header logic here, ideally should be a component -->
    ...
    <div class="profile-header-info">
        ...
        <div class="user-stats">
            <div class="user-stat big">
                <p class="user-stat-title">{{ $followersCount ?? 0 }}</p>
    ...
    <div class="grid-column">
        <div class="section-header">
            <div class="section-header-info">
                <h2 class="section-title">{{ __('messages.Followers') }}</h2>
            </div>
        </div>
        ...
        <div class="grid">
            ...
            @empty
                <div class="widget-box">
                    <p class="widget-box-title">{{ __('messages.no_followers') }}</p>
                </div>
            @endforelse
        </div>
        {{ $followers->links() }}
