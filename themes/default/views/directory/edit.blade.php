...
@section('content')
<div class="directory-edit-shell superdesign-post-container">
            ...
            <div class="superdesign-hero-title-wrap">
                ...
                <div>
                    <h1 class="superdesign-hero-title">
                        {{ __('messages.EditWebsite') }}
                    </h1>
                    <p class="superdesign-hero-subtitle">
                        {{ __('messages.edit_website_subtitle') ?? 'قم بتحديث وتعديل تفاصيل الموقع لضمان توفير بيانات دقيقة ومحدثة للزوار' }}
                    </p>
                </div>
            </div>
        ...
        <div class="superdesign-composer-card">
            ...
            <form method="POST" action="{{ route('directory.update', $listing->id) }}">
                ...
                <div class="superdesign-fields-row">
                    <div class="superdesign-field-group">
                        ...
                        <div class="superdesign-input-wrapper">
                            <div class="superdesign-input-icon">
                                <i class="fa fa-link"></i>
                            </div>
                            <input 
                                type="url" 
                    ...
                    <div class="superdesign-field-group">
                        ...
                        <div class="superdesign-input-wrapper">
                            <input 
                                ...
                                name="tag" 
                                class="superdesign-input" 
                                value="{{ old('tag', $listing->metakeywords) }}"
                            >
                        </div>
                    </div>
                </div>
                ...
                <div class="superdesign-actions-bar">
                    <a href="{{ route('directory.show', $listing->id) }}" class="superdesign-btn-secondary">
            ...
            <div class="superdesign-sidebar-card">
                ...
                <ul class="superdesign-guidelines-list">
                    <li>
                        ...
                        <span>تأكد من صحة الرابط وعمله بشكل سليم دون انقطاع.</span>
                    </li>
                    <li>
                        <i class="fa fa-check-circle"></i>
                        <span>اختر القسم الأكثر ملاءمة لمساعدتك في الحصول على زيارات مستهدفة.</span>
                    </li>
                    <li>
                        <i class="fa fa-check-circle"></i>
                        <span>حدث الوصف بكلمات مفتاحية واضحة لزيادة ظهورك في نتائج البحث.</span>
                    </li>
                </ul>
            </div>
        </div>
...
<style>
/* --- @.superdesign Core Tokens for /directory/{id}/edit --- */
