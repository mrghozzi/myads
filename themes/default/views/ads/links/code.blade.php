          ...
          <div class="tab-box-items">
            ...
            <div class="tab-box-item" style="display: block;">
              ...
              <div class="tab-box-item-content">
                ...
                <textarea class="form-control" type="text" readonly onclick="this.select(); document.execCommand('copy');"><script type="text/javascript" src="{{ route('ads.link.script') }}?ID={{ $user->id }}&px=468x60"></script>{{ $extensions_code }}</textarea>
                </div>
                <!-- TAB BOX ITEM PARAGRAPH -->
                <p class="tab-box-item-paragraph">
                <center><script type="text/javascript" src="{{ route('ads.link.script') }}?ID={{ $user->id }}&px=468x60"></script></center>
                </p>
                <!-- /TAB BOX ITEM PARAGRAPH -->
              </div>
              <!-- /TAB BOX ITEM CONTENT -->
            ...
            <div class="tab-box-item" style="display: none;">
              ...
              <div class="tab-box-item-content">
                ...
                <!-- /TAB BOX ITEM TITLE -->
                <div class="well" style="color: black;" >
                <textarea class="form-control" type="text" readonly onclick="this.select(); document.execCommand('copy');"><script type="text/javascript" src="{{ route('ads.link.script') }}?ID={{ $user->id }}&px=510x320"></script>{{ $extensions_code }}</textarea>
                </div>
                <!-- TAB BOX ITEM PARAGRAPH -->
                <p class="tab-box-item-paragraph">
                <center><script type="text/javascript" src="{{ route('ads.link.script') }}?ID={{ $user->id }}&px=510x320"></script></center>
                </p>
                <!-- /TAB BOX ITEM PARAGRAPH -->
              </div>
              <!-- /TAB BOX ITEM CONTENT -->
