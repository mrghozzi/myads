...
@section('content')
<div class="smart-edit-shell superdesign-post-container">
    ...
    <div class="superdesign-post-grid">
        <!-- Column 1: Sidebar Information & Performance -->
        <div class="superdesign-sidebar-col">
            ...
            <div class="superdesign-sidebar-card">
                ...
                <div style="display: flex; flex-direction: column; gap: 14px; padding: 6px 0 20px;">
                    <div style="display: flex; align-items: center; justify-content: space-between; font-size: 14px; background: #f8fafc; padding: 10px 14px; border-radius: 12px;">
                        <span style="color: #64748b; font-weight: 600;">
                            <i class="fa fa-eye text-primary me-2"></i>
                            {{ __('messages.smart_impressions_label') }}
                        </span>
                        <span style="font-weight: 800; color: #1e293b;">
                            {{ number_format($smartAd->impressions) }}
                        </span>
                    </div>

                    <div style="display: flex; align-items: center; justify-content: space-between; font-size: 14px; background: #f8fafc; padding: 10px 14px; border-radius: 12px;">
                        <span style="color: #64748b; font-weight: 600;">
                            <i class="fa fa-mouse-pointer text-success me-2"></i>
                            {{ __('messages.smart_clicks_label') }}
                        </span>
                        <span style="font-weight: 800; color: #1e293b;">
                            {{ number_format($smartAd->clicks) }}
                        </span>
                    </div>
                </div>
...
<style>
/* --- @.superdesign Core Tokens for /ads/smart/{id}/edit --- */
