<nav id="navigation-widget-mobile" class="navigation-widget navigation-widget-mobile sidebar left hidden" data-simplebar>
    ...
    <ul class="menu">
        ...
        <li class="menu-item {{ Request::is('groups*') ? 'active' : '' }}"><a class="menu-item-link text-tooltip-tfr" href="{{ route('groups.index') }}"><i class="fa fa-users" aria-hidden="true"></i>{{ __('messages.groups_title') }}</a></li>
