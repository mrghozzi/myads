<nav id="navigation-widget-mobile" class="navigation-widget navigation-widget-mobile sidebar left hidden" data-simplebar>
    ...
    <ul class="menu">
        ...
        <li class="menu-item {{ Request::is('directory*', 'dr*', 'cat*', 'add-site*') ? 'active' : '' }}"><a class="menu-item-link text-tooltip-tfr" href="{{ url('/directory') }}"><svg class="menu-item-link-icon icon-directory"><use xlink:href="#svg-directory"></use></svg>{{ __('messages.directory') }}</a></li>
        <li class="menu-item {{ Request::is('orders*') ? 'active' : '' }}"><a class="menu-item-link text-tooltip-tfr" href="{{ url('/orders') }}"><svg class="menu-item-link-icon icon-orders"><use xlink:href="#svg-orders"></use></svg>{{ __('messages.order_requests') }}</a></li>
        ...
        <li class="menu-item {{ Request::is('news*') ? 'active' : '' }}"><a class="menu-item-link text-tooltip-tfr" href="{{ url('/news') }}"><svg class="menu-item-link-icon icon-news"><use xlink:href="#svg-news"></use></svg>{{ __('messages.news') }}</a></li>
        @auth
