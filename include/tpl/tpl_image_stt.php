...
$service = "service" ;
$catusc = $db_con->prepare("SELECT *  FROM options WHERE  ( o_type='{$service}' AND o_parent='{$sucat['id']}' ) ");
$catusc->execute();
...
<div class=\"col-md-4 phot-grid\">
				{$catussc['o_valuer']}
                                 ...
                                 <div class=\"col-md-8 phot-grid\">
                                  ...
                                  <h3>  <a href=\"{$url_site}/t{$sucat['id']}\"  >{$sucat['name']}</a></h3>
                                   <p> {$dir_text} ... </p>
		...
		<div class=\"photo-text\">
           ...
           echo " </div>
								  <div class=\"col-md-4 phot-grid\">
									...
									<div class=\"col-md-4 phot-grid\">
										<p><a href=\"{$url_site}/t{$sucat['id']}\" >{$lang['preview']}&nbsp;<i class=\"fa fa-image\" aria-hidden=\"true\"></i></a></p>
									</div>
                         <script>
