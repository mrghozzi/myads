		...
		<div class=\"photo-text\">
           ...
           echo " </div>
								  <div class=\"col-md-4 phot-grid\">
									...
									<div class=\"col-md-4 phot-grid\">
										<p><a href=\"{$url_site}/producer/{$catussc['name']}\" >{$lang['preview']}&nbsp;<i class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i></a></p>
									</div>
                         <script>
...
title=\"<b>Variables when previewing text.</b>\" ><i class=\"fa fa-question-circle\" aria-hidden=\"true\"></i></button>
                           <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">{$lang['close']}</button>
                           </form>
							</div>
						</div>
