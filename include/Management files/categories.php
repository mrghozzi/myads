					...
					<div class=\"modal-content modal-info\">
						...
						<div class=\"modal-body\">
							<div class=\"more-grids\">
                                    ...
                                    <center><a  href=\"admincp?f_cat_b={$wt['id']}\" class=\"btn btn-danger\" >Delete</a></center>
									  <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button
   ...
   if($_COOKIE['admin']==$hachadmin)
{
	  ...
	  if($_POST['ed_submit']){
           ...
           if(!isset($bnerrMSG))
		{
            ...
            $stmsb = $db_con->prepare("UPDATE f_cat SET name=:a_da,icons=:opm
            WHERE id=:ertb ");
   ...
   if($_COOKIE['admin']==$hachadmin)
{
 ...
 if($_POST['ed_submit']){
           ...
           if(!isset($bnerrMSG))
		{
            ...
            $stmsb = $db_con->prepare("INSERT INTO f_cat (name,icons)
            VALUES(:a_da,:opm) ");
			$stmsb->bindParam(":opm", $bn_icons);
            $stmsb->bindParam(":a_da", $bn_name);
					...
					<div class=\"modal-content modal-info\">
						...
						<div class=\"modal-body\">
							<div class=\"more-grids\">
                                    <h3>Delete !</h3>
									<p>Sure to Delete ID no {$wt['id']} ? </p><br />
                                    <center><a  href=\"admincp?d_cat_b={$wt['id']}\" class=\"btn btn-danger\" >Delete</a></center>
									<button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button
                             </div>
						</div>
					</div>
