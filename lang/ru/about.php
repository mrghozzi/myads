...
return array (
  ...
  'feature_1_title' => 'Окна Кода Superdesign и Движок Диаграмм Mermaid',
  'feature_1_desc' => 'Интерактивные диаграммы архитектуры Mermaid и темные окна кода в стиле macOS с копированием в один клик, нумерацией строк и поддержкой светлой/темной тем в Базе Знаний, Магазине и на Форуме.',
  'feature_2_title' => 'Доверие Протоколу Reverse Proxy и Cloudflare',
  'feature_2_desc' => 'Полное доверие заголовкам обратного прокси и Cloudflare (trustProxies), предотвращающее потерю тела запросов при HTTPS-перенаправлениях и ошибки 405/403.',
  'feature_3_title' => 'Маршруты Разработчиков и JSON-Архитектура',
  'feature_3_desc' => 'Числовые ограничения маршрутов (->whereNumber), стандартизированные JSON-данные (application/json) в формах разработчиков и полная безопасность исключений (\Throwable).',
  'feature_4_title' => 'Сквозная Стойкость Кастомизатора Тем',
  'feature_4_desc' => 'Улучшенный каскадный приоритет CSS, динамическое внедрение в заголовок, многостраничный переключатель предпросмотра и компилированные CSS-переменные.',
  'feature_5_title' => 'Синхронизация Счетчика Сообщений в SSE',
  'feature_5_desc' => 'Исправлена логика подсчета непрочитанных сообщений в потоке SSE, устранены ложные счетчики +99 на активных аккаунтах и синхронизировано состояние с API.',
  'feature_6_title' => 'Усиление Безопасности и Обновление Пакетов',
  'feature_6_desc' => 'Устранена XSS-уязвимость в league/commonmark (v2.10.0 - Dependabot #70), обновлен nette/schema (v1.3.6) и усилена обработка исключений.',
