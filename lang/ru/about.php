...
return array (
  ...
  'feature_1_title' => 'Комплексная оптимизация производительности и ускорение TTFB',
    'feature_1_desc' => 'Радикальное снижение времени отклика сервера (TTFB) до менее 100 мс. Статическое кэширование и пакетная предзагрузка устраняют более 88% SQL-запросов.',
    'feature_2_title' => 'Асинхронная система очередей и приоритетные каналы',
    'feature_2_desc' => 'Высокопроизводительная асинхронная архитектура с 4 выделенными каналами (high, default, media, maintenance), мгновенные уведомления и перезапуск сбоев в 1 клик.',
    'feature_3_title' => 'Платформа разработчиков и универсальная Bearer-авторизация',
    'feature_3_desc' => 'Многоуровневое извлечение токенов для устранения ошибок 401 на Apache и прокси, динамическое предоставление разрешений и надежная публикация постов.',
    'feature_4_title' => 'Центр расширений на AJAX без перезагрузки и автомиграции',
    'feature_4_desc' => 'Автоматическое выполнение миграций БД при активации плагинов, мгновенное AJAX-переключение, динамические фильтры категорий и поиск в реальном времени.',
    'feature_5_title' => 'Усиление системы обновлений и резервные снимки перед установкой',
    'feature_5_desc' => 'Многоэтапное обновление с проверками безопасности (место на диске >= 50 МБ, PHP), автоматические снимки файлов перед перезаписью и сброс OPcache.',
    'feature_6_title' => 'Тематическая структура магазина и расширенное SEO',
    'feature_6_desc' => 'Оптимизированная карточка продукта с вкладкой «Тема» по умолчанию, серверный рендеринг Markdown, Schema.org Product/Offer JSON-LD и сжатие GZIP.',
