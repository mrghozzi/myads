...
return array (
  ...
  'feature_1_title' => '開発者アプリの削除とライフサイクル管理',
  'feature_1_desc' => '開発者（/developer/apps）および管理者（/admin/developers）がアプリを完全に削除し、トークンや権限をデータベース上で自動的にカスケード失効させることができます。',
  'feature_2_title' => '高トラフィックインデックスの耐障害性とMyISAM修正',
  'feature_2_desc' => 'テーブルをInnoDB DYNAMICに変換することでMySQL/MariaDBの1000バイトキー長制限エラーを解消し、ダウンタイムなしの安全な移行を実現します。',
  'feature_3_title' => 'デンジャーゾーンと対話型確認モーダル',
  'feature_3_desc' => '専用のDanger Zoneパネル、厳格な所有権検証、誤削除を防止する対話型確認ダイアログを備えています。',
  'feature_4_title' => 'Live Theme Customizer & Dynamic CSS Engine',
  'feature_4_desc' => 'リアルタイム分割画面プレビュー、ブランドカラー、Googleおよびアラビア語フォント、コンパイル済みCSS注入を備えたビジュアルカスタマイザー（/admin/themes/customizer）。',
  'feature_5_title' => 'リアルタイムイベントエンジンとLive SSE Stream',
  'feature_5_desc' => '通知とメッセージバッジの即時更新、ライブトースト通知を提供する高パフォーマンスServer-Sent Events（SSE）ストリーム（/live/stream）。',
  'feature_6_title' => '不正対策シールドと広告品質エンジン v2',
  'feature_6_desc' => 'IAB Viewability Standard（50%以上の視認性で1秒以上）、リアルタイム動作フィンガープリント、非同期ビュービーコン、広告主PTS保護。',
