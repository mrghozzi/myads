...
return [
  ...
  'feature_1_title' => 'プラットフォーム全体のパフォーマンス刷新とTTFB高速化',
    'feature_1_desc' => 'サーバー応答時間（TTFB）を100ms未満に大幅短縮。インメモリスケジュールと一括プリロードにより、フィードとポータルのクエリを88％以上削減。',
    'feature_2_title' => '非同期キューエンジンと優先チャンネル',
    'feature_2_desc' => '4つの専用チャンネル（high、default、media、maintenance）を備えた高スループット非同期タスク設計、ノンブロッキング通知、1クリック復旧ハブ。',
    'feature_3_title' => '開発者プラットフォームとユニバーサルBearer認証',
    'feature_3_desc' => 'Apacheやリバースプロキシでの401エラーを解決する多層トークン抽出、動的スコープ付与、スキーマ準拠の投稿作成アーキテクチャ。',
    'feature_4_title' => 'リロード不要のAJAX拡張ハブと自動マイグレーション',
    'feature_4_desc' => 'プラグイン有効化時の自動DBマイグレーション、AJAXによる即時ステータス切替、動的バッジカウンター付きカテゴリフィルターとリアルタイム検索。',
    'feature_5_title' => 'アップデートエンジンの堅牢化と事前スナップショット',
    'feature_5_desc' => '事前安全性チェック（空き容量50MB以上、PHPバージョン）、上書き前の自動スナップショットバックアップ、OPcacheリセットを統合。',
    'feature_6_title' => 'トピック優先のストア設計と高度なSEO最適化',
    'feature_6_desc' => 'トピックタブをデフォルトにした商品詳細ビュー、サーバー側Markdownレンダリング、Schema.org Product/Offer JSON-LD、Apache GZIP圧縮。',
