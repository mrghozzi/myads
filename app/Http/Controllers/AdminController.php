...
class AdminController extends Controller
{
    ...
    public function marketplaceRecommendations(PluginManager $pluginManager, ThemeManager $themeManager, RemoteExtensionMarketplaceService $marketplace)
    {
        ...
        $marketplacePlugins = collect($marketplace->catalog('plugins')['items'] ?? [])
            ->filter(fn($p) => !in_array($p['slug'], $installedPluginSlugs))
            ->values();

        $themes = $themeManager->getAllThemes();
        $installedThemeSlugs = collect($themes)->pluck('slug')->toArray();
        $marketplaceThemes = collect($marketplace->catalog('themes')['items'] ?? [])
    ...
    public function index(PluginManager $pluginManager, ThemeManager $themeManager, RemoteExtensionMarketplaceService $marketplace)
    {
        ...
        $adminTips = [
            [
                'id' => 1,
                'category' => __('messages.seo_suite'),
                'icon' => 'feather-search',
                'badge_bg' => 'linear-gradient(135deg, #615dfa, #23d2e2)',
                'title' => __('messages.tip_seo_title'),
                'tip' => __('messages.tip_seo_desc'),
                'action_text' => __('messages.seo_suite'),
                'action_url' => route('admin.seo.index'),
            ],
            [
                'id' => 2,
                'category' => __('messages.pts_activities'),
                'icon' => 'feather-award',
                'badge_bg' => 'linear-gradient(135deg, #f59e0b, #d97706)',
                'title' => __('messages.tip_pts_title'),
                'tip' => __('messages.tip_pts_desc'),
                'action_text' => __('messages.pts_activities'),
                'action_url' => route('admin.pts_activities'),
            ],
            [
                'id' => 3,
                'category' => __('messages.system_monitor'),
                'icon' => 'feather-cpu',
                'badge_bg' => 'linear-gradient(135deg, #10b981, #059669)',
                'title' => __('messages.tip_cleanup_title'),
                'tip' => __('messages.tip_cleanup_desc'),
                'action_text' => __('messages.database_cleanup'),
                'action_url' => route('admin.database_cleanup'),
            ],
            [
                'id' => 4,
                'category' => __('messages.store'),
                'icon' => 'feather-shopping-bag',
                'badge_bg' => 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
                'title' => __('messages.tip_store_title'),
                'tip' => __('messages.tip_store_desc'),
                'action_text' => __('messages.discounts'),
                'action_url' => route('admin.store.discounts.index'),
            ],
            [
                'id' => 5,
                'category' => __('messages.custom_ads'),
                'icon' => 'feather-grid',
                'badge_bg' => 'linear-gradient(135deg, #8b5cf6, #6d28d9)',
                'title' => __('messages.tip_custom_ads_title'),
                'tip' => __('messages.tip_custom_ads_desc'),
                'action_text' => __('messages.custom_ads'),
                'action_url' => route('admin.custom_ads.index'),
            ],
            [
                'id' => 6,
                'category' => __('messages.security'),
                'icon' => 'feather-shield',
                'badge_bg' => 'linear-gradient(135deg, #ef4444, #b91c1c)',
                'title' => __('messages.tip_security_title'),
                'tip' => __('messages.tip_security_desc'),
                'action_text' => __('messages.security'),
                'action_url' => route('admin.security.index'),
            ],
            [
                'id' => 7,
                'category' => __('messages.media_manager'),
                'icon' => 'feather-folder',
                'badge_bg' => 'linear-gradient(135deg, #64748b, #334155)',
                'title' => __('messages.tip_media_title'),
                'tip' => __('messages.tip_media_desc'),
                'action_text' => __('messages.media_manager'),
                'action_url' => route('admin.media'),
            ],
            [
                'id' => 8,
                'category' => __('messages.system_updates'),
                'icon' => 'feather-zap',
                'badge_bg' => 'linear-gradient(135deg, #f59e0b, #b45309)',
                'title' => __('messages.tip_update_title'),
                'tip' => __('messages.tip_update_desc'),
                'action_text' => __('messages.check_for_updates'),
                'action_url' => route('admin.updates'),
            ],
            [
                'id' => 9,
                'category' => __('messages.video_hub'),
                'icon' => 'feather-video',
                'badge_bg' => 'linear-gradient(135deg, #ec4899, #be185d)',
                'title' => __('messages.tip_videohub_title'),
                'tip' => __('messages.tip_videohub_desc'),
                'action_text' => __('messages.video_hub'),
                'action_url' => route('video.index'),
            ],
            [
                'id' => 10,
                'category' => __('messages.widgets'),
                'icon' => 'feather-layout',
                'badge_bg' => 'linear-gradient(135deg, #06b6d4, #0891b2)',
                'title' => __('messages.tip_widgets_title'),
                'tip' => __('messages.tip_widgets_desc'),
                'action_text' => __('messages.widgets'),
                'action_url' => route('admin.widgets'),
            ],
            [
                'id' => 11,
                'category' => __('messages.orders'),
                'icon' => 'feather-briefcase',
                'badge_bg' => 'linear-gradient(135deg, #f97316, #c2410c)',
                'title' => __('messages.tip_orders_title'),
                'tip' => __('messages.tip_orders_desc'),
                'action_text' => __('messages.orders'),
                'action_url' => route('admin.orders.index'),
            ],
            [
                'id' => 12,
                'category' => __('messages.forum'),
                'icon' => 'feather-message-square',
                'badge_bg' => 'linear-gradient(135deg, #84cc16, #4d7c0f)',
                'title' => __('messages.tip_forum_title'),
                'tip' => __('messages.tip_forum_desc'),
                'action_text' => __('messages.forum_cats'),
                'action_url' => route('admin.forum_categories'),
            ],
            [
                'id' => 13,
                'category' => __('messages.billing'),
            ...
            [
                'id' => 14,
                'category' => __('messages.knowledgebase'),
                'icon' => 'feather-book-open',
                'badge_bg' => 'linear-gradient(135deg, #14b8a6, #0f766e)',
                'title' => __('messages.tip_kb_title'),
                'tip' => __('messages.tip_kb_desc'),
                'action_text' => __('messages.knowledgebase'),
                'action_url' => route('admin.knowledgebase'),
            ],
            [
                'id' => 15,
                'category' => __('messages.mobile_settings_title'),
                'icon' => 'feather-smartphone',
                'badge_bg' => 'linear-gradient(135deg, #a855f7, #7e22ce)',
                'title' => __('messages.tip_mobile_title'),
                'tip' => __('messages.tip_mobile_desc'),
                'action_text' => __('messages.open_mobile_settings'),
                'action_url' => route('admin.settings.mobile'),
            ],
            [
                'id' => 16,
                'category' => __('messages.yt_campaigns'),
                'icon' => 'feather-youtube',
                'badge_bg' => 'linear-gradient(135deg, #dc2626, #991b1b)',
                'title' => __('messages.tip_youtube_title'),
