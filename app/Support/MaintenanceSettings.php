...
class MaintenanceSettings
{
    ...
    public static function normalizeIncoming(array $values): array
    {
        ...
        return self::normalize([
            ...
            'allowed_ips' => array_key_exists('allowed_ips', $values) ? $values['allowed_ips'] : $current['allowed_ips'],
            'emergency_token' => array_key_exists('emergency_token', $values) ? $values['emergency_token'] : $current['emergency_token'],
            'estimated_duration' => array_key_exists('estimated_duration', $values) ? $values['estimated_duration'] : $current['estimated_duration'],
    ...
    private static function normalize(array $values): array
    {
        return [
            ...
            'allowed_ips' => self::stringish($values['allowed_ips'] ?? self::DEFAULTS['allowed_ips']),
            'emergency_token' => self::stringish($values['emergency_token'] ?? self::DEFAULTS['emergency_token']),
            'estimated_duration' => self::stringish($values['estimated_duration'] ?? self::DEFAULTS['estimated_duration']),
