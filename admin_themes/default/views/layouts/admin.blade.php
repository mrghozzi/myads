...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ admin_asset('admin-duralux/images/favicon.ico') }}">
    <script>
        (function() {
    ...
    <link rel="stylesheet" type="text/css" href="{{ admin_asset('admin-duralux/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ admin_asset('admin-duralux/vendors/css/vendors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ admin_asset('admin-duralux/css/theme.min.css') }}">
    @if(is_locale_rtl())
        <link rel="stylesheet" type="text/css" href="{{ admin_asset('admin-duralux/css/rtl.css') }}">
    @endif
...
<body data-dir="{{ $pageDirection }}" class="{{ $pageDirection }} admin-premium-shell">
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('admin.index') }}" class="b-brand">
                    <img src="{{ admin_asset('admin-duralux/images/logo-full.png') }}" alt="" class="logo logo-lg">
                    <img src="{{ admin_asset('admin-duralux/images/logo-abbr.png') }}" alt="" class="logo logo-sm">
                </a>
            </div>
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-caption">
                        <label>{{ __('messages.plugins') ?? 'Plugins' }}</label>
                    </li>
                    <!-- Hook for Plugins -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{ auth()->user()->img ? asset(auth()->user()->img) : admin_asset('admin-duralux/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar me-0">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{ auth()->user()->img ? asset(auth()->user()->img) : admin_asset('admin-duralux/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar">
                                    <div>
    ...
    <script src="{{ admin_asset('admin-duralux/vendors/js/vendors.min.js') }}"></script>
