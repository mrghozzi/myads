...
Route::prefix('developer')->group(function () {
    ...
    Route::get('/apps/{app}', [App\Http\Controllers\DeveloperPlatformController::class, 'show'])->name('developer.apps.show')->whereNumber('app');
    Route::put('/apps/{app}', [App\Http\Controllers\DeveloperPlatformController::class, 'update'])->name('developer.apps.update')->whereNumber('app');
    Route::post('/apps/{app}/rotate-secret', [App\Http\Controllers\DeveloperPlatformController::class, 'rotateSecret'])->name('developer.apps.rotate_secret')->whereNumber('app');
    Route::post('/apps/{app}/submit', [App\Http\Controllers\DeveloperPlatformController::class, 'submit'])->name('developer.apps.submit')->whereNumber('app');
    Route::delete('/apps/{app}', [App\Http\Controllers\DeveloperPlatformController::class, 'destroy'])->name('developer.apps.destroy')->whereNumber('app');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/groups/{group}/members/{membership}/transfer', [GroupController::class, 'transferOwnership'])->name('groups.transfer');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/messages/updates', [MessageController::class, 'updates'])->name('messages.updates');
...
Route::post('/post', [ForumController::class, 'store'])->name('forum.store')->middleware(['auth', 'throttle:15,1']);
Route::get('/editor/{id}', [ForumController::class, 'edit'])->name('forum.edit')->middleware('auth');
Route::post('/editor/{id}', [ForumController::class, 'update'])->name('forum.update')->middleware(['auth', 'throttle:15,1']);
Route::post('/forum/delete', [ForumController::class, 'destroy'])->name('forum.delete')->middleware(['auth', 'throttle:10,1']);
...
Route::post('/directory/store', [DirectoryController::class, 'store'])->name('directory.store')->middleware(['auth', 'throttle:10,1']);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/store/{name}/downloads', [StoreController::class, 'downloads'])->name('store.downloads');
    Route::get('/store/{name}/updates-management', [StoreController::class, 'updates'])->name('store.updates');
    Route::delete('/store/{name}/updates-management/{file}', [StoreController::class, 'destroyUpdate'])->name('store.updates.destroy');
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/admins/search-users', [AdminAdminsController::class, 'searchUsers'])->name('admin.admins.search_users');
    ...
    Route::patch('/admins/{siteAdmin}/status', [AdminAdminsController::class, 'toggleStatus'])->name('admin.admins.status');
