...
echo "
   <div class=\"widget-box\">
    <div class=\"widget-box-content\">
     <form  method=\"post\" class=\"form\" action=\"admincp.php?f_cat_a\">
     <div class=\"form-row\">
      <div class=\"form-item\">
      <!-- FORM INPUT -->
     ...
     <!-- FORM INPUT -->
      <div class=\"form-input small active\">
       <label for=\"{$lang['was_desc']}\">{$lang['was_desc']}</label>
     ...
     <div class=\"form-item\">
      <!-- FORM INPUT -->
       <div class=\"form-select\">
        <label for=\"Icons\"><i class=\"fa-solid fa-icons\"></i> Icons</label> 
         <select name=\"icons\" class=\"form-control\" autocomplete=\"off\">
      ...
      <!-- FORM INPUT -->
       ...
       <i class=\"fa-solid fa-circle-plus\"></i>  {$lang['add']}
       </button>
     <!-- /FORM INPUT -->
      </div>
      <div class=\"form-item\">
