...
<div class="grid-column" >
			...
			<div class="widget-box">
					<h2 class="hdg">Forum categories</h2>
 ...
 <form id=\"defaultForm\" method=\"post\" class=\"form-horizontal\" action=\"admincp.php?f_cat_a\"><tr>
  ...
  <div class=\"input-group\">
 <center><button type=\"submit\" name=\"ed_submit\" value=\"ed_submit\" class=\"btn btn-primary\"><i class=\"fa fa-plus \"></i></button></center>
