...
echo "<tr>
  ...
  <td><center><a href=\"{$url_site}/u/{$wt['id']}\"><img class=\"imgu-bordered-sm\" src=\"{$url_site}/{$wt['img']}\" style=\"width: 34px;\" alt=\"user image\">&nbsp;<b>{$wt['username']}</b></a></center>
  <br /><div><a href=\"{$url_site}/admincp?state&ty=banner&st={$wt['id']}\" class='btn btn-warning' ><i class=\"fa fa-link \"></i></a>
  ...
  <a href=\"#\" data-toggle=\"modal\" data-target=\"#ban{$wt['id']}\" class='btn btn-danger' ><i class=\"fa fa-ban \"></i></a></div></td>
