...
<div class="section-filters-bar v6">
      ...
      <a href="https://github.com/mrghozzi/myads/wiki/<?php lang('list'); ?>&nbsp;<?php lang('bannads'); ?>" class="button primary " target="_blank">&nbsp;<b><i class="fa fa-question-circle" aria-hidden="true"></i></b></a>
      &nbsp;
      <?php } ?>
