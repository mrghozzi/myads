...
?>
      ...
      <!--  EVENT TITLE -->
      <h1 class="event-title" style="text-align: center"><?php echo $sucat['name']; ?></h1>
      <!-- / EVENT TITLE -->
      <br/>
      ...
      <div class="decorated-feature-list" style="display: block;">
        ...
        <div class="decorated-feature" >
          ...
          <div class="decorated-feature-info">
            ...
            <a class="decorated-feature-title" href="<?php echo $dir_lnk_hash; ?>" ><?php echo $sucat['name']; ?></a>
            <!-- /DECORATED FEATURE TITLE -->

            <!-- DECORATED FEATURE TEXT -->
            <p class="decorated-feature-text" href="<?php echo $dir_lnk_hash; ?>" ><?php echo $var_sdf; ?></p>
            <!-- /DECORATED FEATURE TEXT -->
          </div>
          <!-- /DECORATED FEATURE INFO -->
        </div>
        ...
        <div class="decorated-feature">
          ...
          <div class="decorated-feature-info">
            <!-- DECORATED FEATURE TITLE -->
            <a class="decorated-feature-title" href="<?php echo "{$url_site}/cat/{$catussc['id']}"; ?>"><?php echo $catussc['name']; ?></a>
            <!-- /DECORATED FEATURE TITLE -->
          </div>
          <!-- /DECORATED FEATURE INFO -->
        </div>
        ...
        <div class="decorated-feature">
          ...
          <div class="decorated-feature-info">
            <!-- DECORATED FEATURE TITLE -->
            <p class="decorated-feature-title"><?php echo $lang['desc']; ?></p>
            <!-- /DECORATED FEATURE TITLE -->
          </div>
          <!-- /DECORATED FEATURE INFO -->
        </div>
